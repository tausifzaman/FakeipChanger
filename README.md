...
## New Termux User
```
pkg update -y && pkg upgrade -y && pkg install git -y && pkg install python -y && git clone https://github.com/tausifzaman/FakeipChanger.git && cd FakeipChanger && python3 ipchanger.py
```
## One Line Code
```
